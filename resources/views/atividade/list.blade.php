...
@section('title','Listagem de Atividade Eloquent')
...
<a href="{{route('atividades.add')}}">Adicionar NOVA Tarefa</a><br>
...
<ul>
    ...
    <li>
        <a href="{{ route('atividades.done', ['id' => $tarefa->id]) }}">
        ...
        <a href="{{ route('atividades.edit', ['id' => $tarefa->id]) }}">[ Editar ]</a>
        <a href="{{ route('atividades.delete', ['id' => $tarefa->id]) }}"
